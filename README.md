# BeOkay - Mental Health Screening App
...
**BeOkay** is a bilingual (English/Hindi) mental health screening application that uses AI-powered conversational agents to assess users' mental well-being through PHQ-9 and GAD-7 screening protocols. The app features:
